    ...
    <tr>
        ...
        if(mysqli_num_rows($result)>0){
            ...
            ?>
                ...
                <td><a href="updategallery.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                <td><a href="deletegallery.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Delete</a></td>
                </tr>
                <?php
            }
        }
